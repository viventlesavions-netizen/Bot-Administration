...
mkdir -p /home/avions/bot_admin
cd /home/avions/bot_admin
...
**Exemple concret :**
```env
TELEGRAM_TOKEN=8542771355:AAGimw6EAN3z-hZ4oJpPCX4keuUCknDzaqk
GEMINI_API_KEY=AIzaSyAUA69yubmNdO4zht0ftpfXCm-YO2IgY0E
ALLOWED_USER_ID=7468870082
```
...
sudo chown -R avions:avions /home/avions/bot_admin

# Permissions sécurisées
chmod 700 /home/avions/bot_admin
chmod 600 /home/avions/bot_admin/.env
chmod 644 /home/avions/bot_admin/chat-bot.py
```
...
[Service]
User=avions
WorkingDirectory=/home/avions/bot_admin
Environment="TZ=Europe/Paris"
ExecStart=/home/avions/bot_admin/venv/bin/python /home/avions/bot_admin/chat-bot.py
Restart=on-failure
RestartSec=10
